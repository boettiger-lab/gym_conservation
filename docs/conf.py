...
version_file = os.path.join(os.path.dirname(__file__), "../gym_conservation", "version.txt")
with open(version_file, "r") as file_handler:
    __version__ = file_handler.read().strip()

# -- Project information -----------------------------------------------------

project = "conservation Gym"
copyright = "2020, Carl Boettiger"
...
htmlhelp_basename = "Gymconservationdoc"
